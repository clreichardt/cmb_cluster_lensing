...
sys_path_folder=(something for user home directory) + 'cmb_cluster_lensing/python/'
...
if __name__ == "__main__":
    ...
    #throw input args to function
    #up to changing here
    create_sims(paramfile, start=start, end=end, cluster_or_randoms = cluster_or_randoms, random_seed_for_sims=random_seed_for_sims)
            
########################

########################
def create_sims(paramfile,
                start=0, end=10, cluster_or_randoms = 'clusters', random_seed_for_sims=-1)
    ...
    nfft = flatsky.figure_fft_size(nx)
    boxsize_am = nx*dx
    ...
    for index in range(start,end):
        ...
        large_cutout, local_mask = tools.get_big_cutout(mapparams,index,
                                                        data_type,
                                                        sim_info=sim_info,
                                                        data_info=data_info )
